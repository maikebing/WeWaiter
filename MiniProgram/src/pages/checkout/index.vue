...
<div class="container">
    ...
    <div class="we-dining-details-box">
        <dining-details :dining-details-list="diningDetailsList" @select-meal-style="onSelectMealStyle" @select-tableware="onSelectTableWare"></dining-details>
    </div>
